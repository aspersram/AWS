...
#Set Machineup for Ansible Connection START
...
#Set Machineup for Ansible Connection END
...
$u="Uptime-$($uptime.hours.tostring())" + "H" + "$($uptime.minutes.tostring())" + "M" + "$($uptime.seconds.tostring())" + "s" + ".txt"
...
$password = "passwordOniHAL19" #PROD

$secPw = ConvertTo-SecureString $password -AsPlainText -Force

$cred1 = New-Object PSCredential -ArgumentList $username, $secPw

#$AnsibleTower="https://172.31.41.188/api/v1/instances"

connect-ansibletower -credential $cred1 -towerurl 'https://172.31.25.161' -DisableCertificateVerification
